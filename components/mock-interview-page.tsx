...
import { Send, Volume2, VolumeX, Eye, Clock, CheckCircle, Brain, Loader2, HelpCircle, Lightbulb } from "lucide-react"
...
export function MockInterviewPage() {
  ...
  useEffect(() => {
    ...
    if (!hasShownInitialTips) {
      ...
      setTimeout(() => {
        toast.success("🎯 Mock Interview Starting with Savi!", {
          duration: 4000,
          style: {
  ...
  useEffect(() => {
    if (
      ...
      setTimeout(() => {
        speakQuestion(
          "Hi there! I'm Savi, your AI Interview Assistant. Mock interview is starting now. Let's begin with our first question: " +
            questions[0].text,
        )
      }, 2000)
    }
  }, [questionsLoaded, questions, speechEnabled, currentQuestion, cameraReady])

  const initializeInterview = async () => {
    setQuestionStartTime(Date.now())

    // Load unique questions for this session
    try {
      const uniqueQuestions = await QuestionSelector.getUniqueQuestions(session?.user?.email || "anonymous", 8)
      setQuestions(uniqueQuestions)
      setQuestionsLoaded(true)
      console.log("Loaded unique questions:", uniqueQuestions.length)
    } catch (error) {
      ...
      const fallbackQuestions: Question[] = [
        ...
        {
          id: "fallback_3",
          text: "Why are you interested in working for our company specifically?",
          category: "general",
          difficulty: "easy",
        },
        {
        ...
        {
          id: "fallback_5",
          text: "Where do you see yourself professionally in the next 5 years?",
          category: "general",
          difficulty: "easy",
        },
        {
          id: "fallback_6",
          text: "How do you handle stress and pressure in high-stakes situations?",
          category: "behavioral",
          difficulty: "medium",
        },
        {
          id: "fallback_7",
          text: "What motivates you most in your work and career?",
          category: "general",
          difficulty: "easy",
        },
        {
          id: "fallback_8",
          text: "Tell me about a time you failed and what you learned from the experience.",
          category: "behavioral",
          difficulty: "medium",
        },
      ]
  ...
  const finishInterview = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast.success("🎉 Mock interview completed! Generating your report...", {
          duration: 4000,
          style: {
            background: "linear-gradient(135deg, #10b981 0%, #3b82f6 100%)",
            color: "white",
      ...
      <AnimatedPage>
        ...
        <div className="min-h-screen flex items-center justify-center">
          <Card className="glass p-8 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400">Loading personalized questions</p>
          </Card>
        </div>
      </AnimatedPage>
    )
      ...
      <div className="min-h-screen pt-20 pb-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gradient mb-4">Mock Interview with Savi</h1>
